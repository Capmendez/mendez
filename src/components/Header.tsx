      ...
      <div className="container header-container">
        ...
        <nav className={`nav-links ${menuOpen ? "open" : ""}`}>
          ...
          <div className="social-links" style={{ gap: "0.6rem", margin: "0 0.75rem", display: "inline-flex" }}>
            {socials?.twitterUrl && (
              <a href={socials.twitterUrl} target="_blank" rel="noopener noreferrer" className="social-icon-btn" aria-label="Twitter" style={{ width: "28px", height: "28px" }}>
            ...
            {socials?.telegramUrl && (
              <a href={socials.telegramUrl} target="_blank" rel="noopener noreferrer" className="social-icon-btn" aria-label="Telegram" style={{ width: "28px", height: "28px" }}>
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ width: "13px", height: "13px" }}>
                  <path d="M22 2L11 13" />
            ...
            {socials?.githubUrl && (
              <a href={socials.githubUrl} target="_blank" rel="noopener noreferrer" className="social-icon-btn" aria-label="GitHub" style={{ width: "28px", height: "28px" }}>
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ width: "13px", height: "13px" }}>
